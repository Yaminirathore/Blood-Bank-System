...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
        <div class="container">
          <a class="navbar-brand" href="#"><img src="blood-drop.jpg" height="50px" alt=""></a>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow">
                    <img src="register.jpg" class="card-img-top" alt="Donor">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card shadow">
                    <img src="request .webp" height="275px" class="card-img-top" alt="Request Blood">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card shadow">
                    <img src="contact.jpg" class="card-img-top" alt="Contact">
                    <div class="card-body">
